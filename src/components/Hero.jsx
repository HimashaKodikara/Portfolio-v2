...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center relative overflow-hidden pr-20"
    >
      {/* Animated Background */}
      <div className="absolute inset-0 bg-white dark:bg-gray-900">
        ...
        <div
          className="absolute top-40 right-20 w-3 h-3 bg-gray-400 dark:bg-gray-600 rounded-full animate-float"
          style={{ animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute bottom-32 left-1/4 w-2 h-2 bg-gray-400 dark:bg-gray-600 rounded-full animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/3 right-1/3 w-4 h-4 bg-gray-400 dark:bg-gray-600 rounded-full animate-float"
          style={{ animationDelay: "1.5s" }}
        ></div>
        <div
          className="absolute bottom-20 right-10 w-3 h-3 bg-gray-400 dark:bg-gray-600 rounded-full animate-float"
        ...
        <div
          className="absolute bottom-1/4 -right-20 w-96 h-96 bg-gray-200/30 dark:bg-gray-800/30 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
      </div>
          ...
          <div className="text-center lg:text-left animate-slide-left">
            ...
            <div className="mb-6 h-20">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-gray-800 dark:text-white">
                I'm a{" "}
                <span className="text-black dark:text-white underline decoration-4 decoration-gray-400 dark:decoration-gray-600">
                  {typedText}
                </span>
