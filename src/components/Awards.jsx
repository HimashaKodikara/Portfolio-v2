        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {awards.map((award) => (
            ...
            >
              {/* Trophy Icon */}
              <div className="mb-4">
                <div className="w-16 h-16 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
