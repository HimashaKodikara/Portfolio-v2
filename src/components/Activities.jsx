            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 bg-black dark:bg-white rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-black dark:text-white text-xs font-semibold rounded-full">
                      {activity.role}
                    </span>
